...
public class SearchAccountHoldersQueryHandlerTests
{
    ...
    private static AccountHolder CreateHolder(string firstName, string lastName) =>
        AccountHolder.Create(
            firstName, lastName, "A1234567",
    ...
    {
        var holder = CreateHolder("Jane", "Doe");
        ...
        var result = await _handler.Handle(
            new SearchAccountHoldersQuery("Jane", null, null, null, null, null),
    ...
    public async Task Handle_PassesEveryFilterThroughToTheRepositoryQuery()
    {
        ...
        await _handler.Handle(
            new SearchAccountHoldersQuery("Jane", "Doe", "A123", "jane@", 1990, 6),
            CancellationToken.None);
    ...
    public async Task Handle_WithNoSearchCriteria_ThrowsValidationExceptionWithoutQueryingTheRepository()
    {
        var act = async () => await _handler.Handle(
            new SearchAccountHoldersQuery(null, null, null, null, null, null),
            CancellationToken.None);
