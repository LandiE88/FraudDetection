...
public class SearchAccountHoldersQueryValidatorTests
{
    ...
    [Fact]
    public void Validate_WithAccountIdOnly_HasNoErrors()
    {
        var query = new SearchAccountHoldersQuery(Guid.NewGuid(), null, null, null, null, null, null);
    ...
    {
        var query = new SearchAccountHoldersQuery(null, null, null, null, null, null, null);
    ...
    {
        var query = new SearchAccountHoldersQuery(null, null, null, null, null, null, null, Page: 2, PageSize: 50);
    ...
    {
        var query = new SearchAccountHoldersQuery(null, "Jane", null, null, null, null, month);
    ...
    {
        var query = new SearchAccountHoldersQuery(null, "Jane", null, null, null, DateTime.UtcNow.Year + 1, null);
    ...
    {
        var query = new SearchAccountHoldersQuery(null, "Jane", null, null, null, 1899, null);
    ...
    {
        var query = new SearchAccountHoldersQuery(Guid.NewGuid(), null, null, null, null, null, null, Page: page);
    ...
    {
        var query = new SearchAccountHoldersQuery(Guid.NewGuid(), null, null, null, null, null, null, PageSize: pageSize);
    ...
    public void Validate_WithPartialEmailSearchFragment_HasNoErrors()
    {
        ...
        var query = new SearchAccountHoldersQuery(null, null, null, null, "@example.com", null, null);
